...
demographic_events = [
    msprime.MassMigration(time = Tm1, source = 1, destination = 0, proportion = 0.05),
    msprime.PopulationParametersChange(time = Tm1, initial_size = N0, population_id = 0),
    msprime.MassMigration(time = Tm1, source = 0, destination = 1, proportion = 0.02),
...
#    out_ms = open("argv[0]_500kya.rate0.1.P2_Ne_repeat_{}_20210205.ms".format(1 + index), "w")
    out_ms = open("{}_500kya.sigle.rate0.05-0.02.P2_Ne_repeat_{}_20210205.ms".format(sys.argv[1],1 + index), "w")
